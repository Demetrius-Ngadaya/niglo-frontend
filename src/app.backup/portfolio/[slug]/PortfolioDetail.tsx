    ...
    <>
      {project.cover_image_path && (
        <button
          ...
          className="relative aspect-video bg-stoneDark mb-10 w-full block group overflow-hidden"
        >
          ...
          {project.before_image_path && (
            <div>
              ...
              <button
                ...
                className="relative aspect-square bg-stoneDark w-full block group overflow-hidden"
              >
      ...
      {project.description && (
        <div className="prose max-w-none text-ink/80" dangerouslySetInnerHTML={{ __html: project.description }} />
      )}
        ...
        <div className="grid sm:grid-cols-3 gap-4 mt-12">
          {project.images.map((img) => (
            <button
              ...
              className="relative aspect-square bg-stoneDark block group overflow-hidden"
            >
