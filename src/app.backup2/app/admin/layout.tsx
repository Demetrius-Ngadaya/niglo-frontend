...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  if (isLoginPage) {
    return <div className="min-h-screen bg-stone dark:bg-ink">{children}</div>;
  }

  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-stone dark:bg-ink text-ink dark:text-stone">
      <AdminSidebar />
