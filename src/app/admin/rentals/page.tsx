      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        {adding && (
          <div className="border border-brass/30 bg-brass/5 p-5 mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-3 mb-3">
              ...
              <div>
                <input
                  ...
                  className="w-full border border-ink/15 dark:border-stone/15 px-3 py-2 bg-white text-sm focus-ring"
                />
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              {draft.image_path && (
                <img src={imageUrl(draft.image_path)!} alt="" className="w-14 h-14 object-cover border border-ink/10 dark:border-stone/10" />
              )}
            </div>
        ...
        <div className="space-y-8">
            ...
            <div key={categoryName}>
              ...
              <div className="space-y-3">
                {categoryItems.map((item) => (
                  <div key={item.id} className="flex items-center gap-4 border border-ink/10 dark:border-stone/10 bg-white/40 dark:bg-white/5 p-3">
                    {item.image_path && (
                    ...
                    {!item.is_active && <span className="text-xs bg-ink/10 text-ink/50 dark:text-stone/60 px-2 py-0.5 rounded-full">Inactive</span>}
          ...
          {!loading && items.length === 0 && (
            <p className="text-ink/50 dark:text-stone/60 text-sm">No equipment yet — add some to get started.</p>
          )}
        </div>
      </div>
